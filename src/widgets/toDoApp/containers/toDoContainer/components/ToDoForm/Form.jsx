    ...
    <form className={styles.toDoForm_formContainer} onSubmit={handleSubmit}>
      ...
      <div className={styles.toDoForm_inputGroup}>
        ...
        <select
          ...
          onClick={(e) => handleFormDataChange("color", backgroundColors[e.target.value])}
          name="color"
          id="color"
          value={newTask.color}
          ...
          className={styles.toDoForm_input}
        >
          {["default", "green", "yellow", "purple", "turquoise", "brown"].map(
            (colorOption) => <option key={colorOption} value={colorOption}>{colorOption}</option>
          )}
        </select>
      </div>
      <div className={styles.toDoForm_inputGroup}>
        <label htmlFor="priority">priority:</label>
        <select onChange={(event) => handleNewTaskChange("priority", event)}
                onClick={(e) =>
                handleFormDataChange("priority", backgroundColors[e.target.value])}
                name="priority"
                id="priority"
        ...
        >
          {['nopriority', 'high', 'medium', 'low'].map(
      ...
      <div className={styles.toDoForm_submit_closeButton_container}>
        <button type="submit" className={styles.toDoForm_submitButton}>submit</button>
        <button
